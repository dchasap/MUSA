...
{
       0,    79,    79,    87,    79,    98,   105,   105,   107,   134,
     136,   142,   152,   164,   170,   182,   194,   210,   210,   212,
     230,   237,   243,   253,   263,   274,   284,   298
};
#endif
...
static const char *const yytname[] =
{
  ...
  "string_a", "registros", "registro", "campos", "campo", YY_NULL
};
#endif
...
#line 108 "yacc.y"
  ...
  if (add_register_definition((int) (yyvsp[(1) - (6)]), (char *) (yyvsp[(2) - (6)]), (struct t_queue *) (yyvsp[(4) - (6)])))
  {
    near_line();
...
#line 213 "yacc.y"
  ...
  en = exist_identifier((char*) (yyvsp[(1) - (5)]), &Registers_queue);

  if (en != NULL)
  {
    CONFIGURATION_New_Definition((struct t_queue*) (yyvsp[(3) - (5)]), en);
  }
  else
  {
