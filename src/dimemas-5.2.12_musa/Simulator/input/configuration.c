...
printf("CAA: local startup is %lf\n",local_startup);
  /*
...
printf("CAA: remote startup is %lf\n",remote_startup);
...
printf("CAA: external net startup %lf\n",external_net_startup);
...
printf("CAA: local prot startup is %lf\n",local_port_startup);
...
printf("CAA: remote port startup is %lf\n",remote_port_startup);
...
printf("CAA: local memory startup is %lf\n",local_memory_startup);
...
printf("CAA: remote memory startup is %lf\n",remote_memory_startup);
