    ...
    if correction_factor:
        ...
        for r in rank_values:
            ...
            for index in burst_phases.loc[burst_phases['rank'] == r].index.tolist():
                ...
                burst_phases.at[index,'value'] = int(round(new_value))
                burst_phases.at[index,'mode'] = 3 # In presim files mode=3 means value extrapolation

    extrapolated_filename=presim_burst_file.replace("BRST.dat","FINAL.dat")
